...
def get_TFR(pid, ch_index, eid, n_jobs, freqs, n_cycles, time_bandwidth, get_LFP = 'load',  condition = 'Right_Left', tmin = -0.5, tmax = 1 , remove_first_trials_of_block = False, min_trial = 0, **kwargs):
